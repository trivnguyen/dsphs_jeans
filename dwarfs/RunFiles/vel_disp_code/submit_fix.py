...
for fix_tag in ["fix_rho0_r0","fix_rho0","fix_r0"]:
					...
					for deltav, dvtag, dvtag_out in deltav_list:
						for subsamp_tag in subsamp_tag_list:
							...
							# for iMC in [19]:
								...
								rs_stars = rs_dm
								run_tag = "_"+fix_tag+"_asymm_priors"
								...
								batch3 = "python scan_vel_disp_interface_fix.py --setup_dirs --chains_dir $chains_dir --temp_ind $temp_ind "+"\n"
								batch4 = "mpiexec -np 10 python scan_vel_disp_interface_fix.py --run_scan $run_scan --chains_dir $chains_dir --data_file_path $data_file_path --light_profile_params_path $light_profile_params_path "
								batch5 = "--load_light_profile $load_light_profile --fix_light_profile $fix_light_profile --nu_model $nu_model --dm_model $dm_model --nbeta $nbeta --fix_breaks $fix_breaks --fix_tag $fix_tag --deltav $deltav --temp_ind $temp_ind "
								batch6 = "python scan_vel_disp_interface_fix.py --cleanup_dirs --chains_dir $chains_dir --temp_ind $temp_ind --make_plots $make_plots --plots_dir $plots_dir "+"\n"
								batch7 = "python scan_vel_disp_interface_fix.py --make_plots $make_plots --save_plots $save_plots --save_post $save_post --has_truth $has_truth "
								...
								batch9 = "--load_light_profile $load_light_profile --fix_light_profile $fix_light_profile --nu_model $nu_model --dm_model $dm_model --nbeta $nbeta --fix_breaks $fix_breaks --fix_tag $fix_tag --deltav $deltav "
								batch10 = "--true_params "

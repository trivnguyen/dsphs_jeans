...
import scan_vel_disp_multinest_copy
...
args = {"data_file_path":data_file_path, "full_file_path":full_file_path, "light_profile_params_path":light_profile_params_path, 
...
if run_scan:
	scan = scan_vel_disp_multinest_copy.run_scan(**args)

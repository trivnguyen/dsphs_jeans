				...
				for deltav, dvtag, dvtag_out in deltav_list:
					for subsamp_tag in subsamp_tag_list:
						...
						# for iMC in [16]:
							...
							batch4 = "mpiexec -np 112 python scan_vel_disp_interface_copy.py --run_scan $run_scan --chains_dir $chains_dir --data_file_path $data_file_path --full_file_path $full_file_path --light_profile_params_path $light_profile_params_path "

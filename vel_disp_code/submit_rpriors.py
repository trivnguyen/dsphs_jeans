				...
				for deltav, dvtag, dvtag_out in deltav_list:
					for subsamp_tag in subsamp_tag_list:
						...
						# for iMC in [19]:
							...
							batch4 = "mpiexec -np 20 python scan_vel_disp_interface.py --run_scan $run_scan --chains_dir $chains_dir --data_file_path $data_file_path --full_file_path $full_file_path --light_profile_params_path $light_profile_params_path "

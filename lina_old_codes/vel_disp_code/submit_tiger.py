...
chains_dir_base = "/tigress/ljchang/dSph_likelihoods/RunFiles/vel_disp_code/multinest_chains/lina_mocks/"
...
post_dir_base = "/tigress/ljchang/dSph_likelihoods/RunFiles/vel_disp_code/DM_posteriors/lina_mocks/"
...
sim_tag_list =  [
				# ["a_1_b_3_g_1_rdm_1_iso",[64.0,0.25,1.0,3.0,1.0]],
				["a_1_b_3_g_1_rdm_1_iso",[64.0,1.0,1.0,3.0,1.0]],
				# ["a_1_b_3_g_0_rdm_1_iso",[400.0,1.0,1.0,3.0,0.0]],
			...
			for nstars in nstars_list:
				for deltav, dvtag, dvtag_out in deltav_list:
					for subsamp_tag in subsamp_tag_list:
						for iMC in range(5,10):
						# for iMC in [0]:
							rho0 = true_params_base[0]
							rs = true_params_base[1]

							data_tag_base = "dist_as_2.0_bs_5.0_gs_0.1_rs_"+str(rs)+"_dm_"+str(nstars)+"_"+str(iMC)+"_rho_"+str(rho0)
							...
							chains_dir = chains_dir_base+"/"+extratext+"/rs_1kpc/"+out_tag_base+"_"+nu_model+"_"+dm_model+run_tag
							...
							plots_dir = plots_dir_base+extratext+"/rs_1kpc/"+out_tag_base+"/"
							post_dir = post_dir_base+extratext+"/rs_1kpc/"+out_tag_base+"/"
							...
							batch4 = "mpiexec -np 120 python scan_vel_disp_interface.py --run_scan $run_scan --chains_dir $chains_dir --data_file_path $data_file_path --light_profile_params_path $light_profile_params_path "

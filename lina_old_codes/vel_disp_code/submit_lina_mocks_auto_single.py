# July 7, 2020: Tunisia Quarantine :D 
# Running specific J-factors
...
gamma_dm_list = np.array([1]) # np.array([0, 0, 1, 1]) #,0.5, 0.5, 1.5, 1.5]) #[0, 0,
rs_list = np.array([1]) #np.array([1, 0.2, 1, 0.2]) #,1, 0.2, 1, 0.2]) #,  [1, 0.2, 
rlight_list = rs_list
